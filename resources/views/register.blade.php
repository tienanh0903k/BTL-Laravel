            ...
            <div class="p-5">
              ...
              <form action="{{ route('register.save') }}" method="POST" class="user">
                ...
                <div class="form-group">
                  <input name="fullname" type="text" class="form-control form-control-user @error('name')is-invalid @enderror" id="exampleInputName" placeholder="Name">
                  @error('name')
                ...
                <button type="submit" class="btn btn-primary btn-user btn-block">Đăng kí tài khoản</button>
              </form>
              <hr>
              <div class="text-center">
