                    ...
                    @foreach ($listPr as $pr)
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            <div class="product__item">
                                <div class="product__item__pic set-bg" data-setbg={{asset('uploads/product/'.$pr->thumbnail)}}>
                                    <ul class="product__item__pic__hover">
                                        <li><a href="#"><i class="fa fa-shopping-cart"></i></a></li>
                                    </ul>
                                </div>
                                <div class="product__item__text">
                                    <h6><a href="#">{{$pr->title}}</a></h6>
                                    <span class="original-price">đ{{number_format($pr->price, 0, ',', '.')}}</span>
                                    <h5>đ{{number_format($pr->discount, 0, ',', '.')}}</h5>
                                </div>
                            </div>
                        </div>
                     @endforeach
